...
export const DRIVER_IDENTITY_CONTRACT_ID = process.env.NEXT_PUBLIC_DRIVER_IDENTITY_CONTRACT_ID || "CCDRIVERID4UXJSHR7XEX2YGB5P2GWRQFLRQLOOM7DGLTZWWRHMESH4U2";
